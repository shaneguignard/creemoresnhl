...
var t = new Date();
var currentSeasonYear = (t.getFullYear() - 1) + "/" + t.getFullYear();
var lastSeasonYear = (t.getFullYear() - 2) + "/" + (t.getFullYear() - 1);
//update webpage year
//assign cy and ly array
var cy = [];
var ly = [];
//assing cy array to "currentSeasonYear" class
